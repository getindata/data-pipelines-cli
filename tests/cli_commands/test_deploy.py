...
class DeployCommandTestCase(unittest.TestCase):
    ...
    def test_no_airflow_address(self):
        with self.assertRaises(AirflowDagsPathKeyError):
            DeployCommand("base", False, None, None, False, False, None)
    ...
    def test_airflow_address(self):
        with tempfile.TemporaryDirectory() as tmp_dir, patch(
            ...
            deploy_command = DeployCommand("base", False, None, None, False, False, None)
        self.assertEqual(
    ...
    def test_staging_airflow_address(self):
        with tempfile.TemporaryDirectory() as tmp_dir, patch(
            ...
            deploy_command = DeployCommand("staging", False, None, None, False, False, None)
        self.assertEqual(
